      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400 transition-colors duration-300">{t('dashboard.welcome', language)} / {t('dashboard.welcome', 'kurdish')}</p>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span>{t('dashboard.logout', language)} / {t('dashboard.logout', 'kurdish')}</span>
            </Button>
          </div>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 transition-colors duration-300">{t('dashboard.subtitle', language)}</p>
        </div>
      </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-6 flex items-center justify-between text-sm text-gray-500 dark:text-gray-400">
                    <span className="flex items-center space-x-2">
                      <span>{t('dashboard.clickToExplore', language)}</span>
                      {expandedSections[sectionIndex] && (
