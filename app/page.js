  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
        <div className="px-28 py-2 sm:py-4">
      ...
      {/* Main Content - Add much more top padding and margin for larger spacing from fixed header */}
      <div className="pt-48 mt-0 pb-8 sm:pb-16 px-1 sm:px-2 lg:px-4 max-w-7xl mx-auto overflow-x-visible">
