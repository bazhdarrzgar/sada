...
export default function ActivitiesPage() {
  ...
  if (loading) {
    return (
      <PageLayout title="Activities Management" titleKu="بەڕێوەبردنی چالاکیەکان">
    ...
    <PageLayout title="Activities Management" titleKu="بەڕێوەبردنی چالاکیەکان">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
        <div className="relative flex-1">
          ...
          <Input
            placeholder="گەڕانی فازی لە هەموو ستوونەکانی چالاکیەکاندا... / Fuzzy search across all activities columns..."
            value={searchTerm}
        ...
        <div className="flex items-center gap-4">
          ...
          <PrintButton 
            ...
            titleKu="بەڕێوەبردنی چالاکیەکان"
            columns={[
