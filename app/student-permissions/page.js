...
export default function StudentPermissionsPage() {
  ...
  const stages = ['پۆلی یەکەم', 'پۆلی دووەم', 'پۆلی سێیەم', 'پۆلی چوارەم']
  ...
  const editFields = [
    ...
    },
    {
      key: 'startDate',
      label: 'Start Date',
      labelKu: 'بەروارەی دەستپێک',
      type: 'date'
    },
    {
      key: 'endDate',
      label: 'End Date',
      labelKu: 'بەروارەی کۆتایی',
      type: 'date'
    },
    {
      key: 'status',
          ...
          <Card key={entry.id} className="p-4 theme-card glow-button hover:shadow-xl transition-all duration-300 border-2 hover:border-blue-300 dark:hover:border-blue-500 group">
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div><span className="font-semibold">وانە (Subject):</span> {entry.department}</div>
                <div><span className="font-semibold">پۆل (Stage):</span> {entry.stage}</div>
  ...
  if (loading) {
    return (
      <PageLayout title="Student Permissions Management" titleKu="بەڕێوەبردنی مۆڵەتی قوتابیان">
    ...
    <PageLayout title="Student Permissions Management" titleKu="بەڕێوەبردنی مۆڵەتی قوتابیان">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
        <div className="relative flex-1">
          ...
          <Input
            placeholder="گەڕانی فازی لە هەموو ستوونەکانی تۆمارەکانی مۆڵەتدا... / Fuzzy search across all permission columns..."
            value={searchTerm}
        ...
        <div className="flex items-center gap-4">
          ...
          <PrintButton 
            ...
            titleKu="بەڕێوەبردنی مۆڵەتی قوتابیان"
            columns={[
              { key: 'studentName', header: 'ناوی قوتابی' },
              { key: 'department', header: 'وانە' },
              { key: 'stage', header: 'پۆل' },
          ...
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
            ...
            <DialogContent className="max-w-md">
              ...
              <div className="space-y-4">
                <div>
                  <Label htmlFor="studentName">ناوی قوتابی / Student Name</Label>
                  <Input
                    id="studentName"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="department">وانە / Subject</Label>
                  ...
                  <div>
                    <Label htmlFor="stage">پۆل / Stage</Label>
      ...
      <EditModal
        ...
        titleKu="دەستکاریکردنی مۆڵەتی قوتابی"
      />
