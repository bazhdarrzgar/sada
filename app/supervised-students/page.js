...
export default function SupervisedStudentsPage() {
  ...
  if (loading) {
    return (
      <PageLayout title="Supervised Students" titleKu="قوتابیی چاودێری کراو">
    ...
    <PageLayout title="Supervised Students" titleKu="قوتابیی چاودێری کراو">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
        <div className="relative flex-1">
          ...
          <Input
            placeholder="گەڕانی فازی لە هەموو ستوونەکانی قوتابیە چاودێریکراوەکاندا... / Fuzzy search across all supervised student columns..."
            value={searchTerm}
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="text-right">
            <p className="text-sm text-gray-600 dark:text-gray-400">کۆی قوتابیان</p>
          ...
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
            ...
            <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                <DialogTitle>زیادکردنی قوتابیی چاودێریکراوی نوێ</DialogTitle>
              </DialogHeader>
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="studentName">ناوی قوتابی</Label>
                    <Input
                      id="studentName"
      ...
      <EditModal
        ...
        titleKu="دەستکاریکردنی قوتابیی چاودێریکراو"
      />
      ...
      {filteredData.length === 0 && (
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-lg font-semibold mb-2">هیچ قوتابیێک نەدۆزرایەوە</h3>
            <p className="text-gray-600 dark:text-gray-400">
              {searchTerm ? 'هیچ ئەنجامێک بۆ گەڕانەکەت نەدۆزرایەوە' : 'تا ئێستا هیچ قوتابیێک زیاد نەکراوە'}
            </p>
          </CardContent>
        </Card>
      )}
