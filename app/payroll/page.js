          ...
          <Card key={entry.id} className="p-4 theme-card glow-button hover:shadow-xl transition-all duration-300 border-2 hover:border-blue-300 dark:hover:border-blue-500 group">
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2 text-sm">
                ...
                <div><span className="font-semibold">لێ برین:</span> <span className="text-red-600 dark:text-red-400">{entry.deduction.toLocaleString()}</span></div>
        ...
        <div className="flex items-center gap-4">
          ...
          <PrintButton 
            ...
            columns={[
              ...
              { key: 'deduction', header: 'لێ برین', render: (value) => value.toLocaleString() },
          ...
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
            ...
            <DialogContent className="max-w-md">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="deduction">Deduction / لێ برین</Label>
                    <Input
                      id="deduction"
                      type="number"
