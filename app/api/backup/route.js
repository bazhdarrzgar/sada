...
export async function GET() {
  try {
    ...
    const db = client.db(process.env.DB_NAME || 'berdoz_management'); // Use same DB name as other APIs
    ...
    const backupData = {
      metadata: {
        ...
        version: '1.0.0',
        databaseName: process.env.DB_NAME || 'berdoz_management',
    ...
    for (const collectionInfo of collections) {
      ...
      backupData.collections[collectionName] = serializedDocuments;
