    ...
    <PageLayout title="Exam Supervision Management" titleKu="بەڕێوەبردنی چاودێریکردنی تاقیکردنەوە">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
        <div className="relative flex-1">
          ...
          <Input
            placeholder="گەڕانی فازی لە هەموو ستوونەکانی چاودێریکردنی تاقیکردنەوەکاندا... / Fuzzy search across all exam supervision columns..."
            value={searchTerm}
      ...
      <EditModal
        ...
        title="Edit Exam Supervision"
        titleKu="دەستکاریکردنی چاودێریکردنی تاقیکردنەوە"
      />
    </PageLayout>
  )
}