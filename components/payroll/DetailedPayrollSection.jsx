              ...
              <table className="w-full border-collapse text-xs">
                <thead>
                  <tr className="bg-blue-600 text-white">
                    <th className="border border-gray-300 p-1 px-2 text-center font-semibold whitespace-nowrap overflow-hidden text-ellipsis">ژمارە</th>
                    <th className="border border-gray-300 p-1 px-2 text-center font-semibold whitespace-nowrap overflow-hidden text-ellipsis">ناوی سیانی</th>
                    <th className="border border-gray-300 p-1 px-2 text-center font-semibold whitespace-nowrap overflow-hidden text-ellipsis">بڕی مووچە</th>
                    <th className="border border-gray-300 p-1 px-2 text-center font-semibold whitespace-nowrap overflow-hidden text-ellipsis">پاداشت</th>
                    <th className="border border-gray-300 p-1 px-2 text-center font-semibold whitespace-nowrap overflow-hidden text-ellipsis">سزا</th>
                    <th className="border border-gray-300 p-1 px-2 text-center font-semibold whitespace-nowrap overflow-hidden text-ellipsis">پوختەی مووچە</th>
                    <th className="border border-gray-300 p-1 px-2 text-center font-semibold whitespace-nowrap overflow-hidden text-ellipsis">تێبنی</th>
                    <th className="border border-gray-300 p-1 px-2 text-center font-semibold whitespace-nowrap overflow-hidden text-ellipsis">کردارەکان</th>
                  </tr>
                </thead>
                <tbody>
