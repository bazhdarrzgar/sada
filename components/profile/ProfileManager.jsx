...
const ProfileManager = ({ children }) => {
  ...
  const handleRestoreUpload = async () => {
    ...
    try {
      ...
      toast.success(`Backup restored successfully! Restored ${result.restoredCollections} collections with ${result.restoredDocuments} documents.`)
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                    ...
                    <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                      <li>• All MongoDB collections and data</li>
