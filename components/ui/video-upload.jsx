      ...
      <div className="space-y-4">
        ...
        <div className="relative group">
          <Button
            ...
            disabled={disabled || uploading || videos.length >= maxVideos}
            className="w-full flex items-center justify-center gap-3 h-24 border-2 border-dashed border-blue-300 hover:border-blue-500 dark:border-blue-600 dark:hover:border-blue-400 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950 dark:to-indigo-950 hover:from-blue-100 hover:to-indigo-100 dark:hover:from-blue-900 dark:hover:to-indigo-900 transition-all duration-300 rounded-xl shadow-lg hover:shadow-xl"
          >
            {uploading ? (
              ...
              <div className="text-center">
                ...
                <div className="text-lg font-semibold text-gray-800 dark:text-gray-200">{placeholder}</div>
                <div className="text-sm text-blue-600 dark:text-blue-400 font-medium mt-1">
                  ڤیدیۆ بارکە ({videos.length}/{maxVideos})
                </div>
                <div className="text-xs text-gray-500 mt-1">
                  Drag & drop or click to select • Max 50MB each
                </div>
              </div>
            )}
          </Button>
