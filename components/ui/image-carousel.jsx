...
import { ChevronLeft, ChevronRight, X, ZoomIn, ZoomOut, Download, Image as ImageIcon, RotateCw, Maximize2, Minimize2 } from 'lucide-react'
      ...
      <Dialog open={isOpen} onOpenChange={setIsOpen}>
        <DialogPrimitive.Portal>
          ...
          >
            ...
            {/* Scrollable Main Image Container */}
            <div 
              className="flex-1 overflow-auto scrollbar-thin scrollbar-thumb-white/20 scrollbar-track-transparent"
            ...
            <div className="absolute bottom-28 left-4 text-white/40 text-xs hidden lg:block">
              <p>Keyboard: ← → (navigate) | + - (zoom) | R (rotate) | 0 (reset) | Esc (close)</p>
            </div>
          </div>
        </DialogPrimitive.Content>
      </DialogPrimitive.Portal>
